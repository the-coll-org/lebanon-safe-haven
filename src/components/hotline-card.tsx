  ...
  return (
    <Card className="rounded-sm border-border">
      <CardContent className="p-4">
        <h3 className="font-bold text-sm uppercase tracking-wide text-secondary mb-3">
        ...
        <div className="flex flex-col gap-2">
          {hotline.numbers.map((num) => (
            <Button
              key={num.number}
              variant="outline"
              className="gap-2 justify-start h-auto py-3 rounded-sm border-primary/40 text-primary hover:bg-primary/5 hover:border-primary"
              asChild
            >
