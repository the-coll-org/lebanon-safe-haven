        ...
        <CardHeader>
          <div className="flex items-start justify-between gap-2">
            <CardTitle className="text-xl">
              <div className="flex items-center gap-2 flex-wrap font-bold uppercase tracking-wide text-secondary">
                <MapPin className="h-5 w-5 shrink-0" />
                {tr(listing.region)}
                {listing.area && (
                  <span className="text-base font-normal normal-case tracking-normal text-muted-foreground">
                    — {listing.area}
                  </span>
                )}
              </div>
